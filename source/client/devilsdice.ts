...
// Defines the name of this module. Same as putting this code into a file at path: bgagame/devilsdice.ts
...
class DevilsDice extends Gamegui
{
	...
	constructor(){
		super();
		console.log('devilsdice constructor');
	}
...
// The global 'bgagame.devilsdice' class is instantiated when the page is loaded and used as the Gamegui.
window.bgagame = { devilsdice: DevilsDice };